...
export function VideoPanel({
  ...
  return (
    <div className="flex flex-col items-center w-full px-4 pt-6 pb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl aspect-video mb-5">
        ...
        <div className="relative bg-slate-900 rounded-3xl flex items-center justify-center border-2 border-cyan-400 shadow-[0_0_20px_rgba(34,211,238,0.2)] overflow-hidden transition-all duration-300 min-h-[200px]">
          ...
          <div className="absolute top-4 right-4 flex gap-2 z-10">
            {isMuted && (
              <span className="bg-amber-500/90 text-slate-950 font-semibold text-[10px] px-2 py-0.5 rounded-md">
                MUTED
              </span>
            )}
            {!isCameraOn && (
      ...
      <div className={`${chatToolbar} mb-2`}>
      ...
      <div className={`${chatToolbar} mb-4`}>
        <button
          type="button"
