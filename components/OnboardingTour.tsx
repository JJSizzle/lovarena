...
export function OnboardingTour() {
  ...
  return (
    <AppModal
      ...
      panelClassName="w-full max-w-md rounded-3xl border-2 border-fuchsia-500 bg-slate-900 p-6 shadow-[0_0_40px_rgba(217,70,239,0.25)]"
      overlayClassName="fixed inset-0 z-[80] bg-slate-950/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-4"
    >
